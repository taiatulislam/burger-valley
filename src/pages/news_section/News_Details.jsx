    ...
    return (
        <>
            ...
            <div className="lg:flex px-1 md:px-2 lg:px-4 py-1 lg:py-2 bg-black ">
                ...
                {/* left side  */}
                <div className=" lg:w-8/12 w-full  flex flex-col items-center  rounded-lg shadow  hover:bg-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    ...
                    <div className='text-white px-1 md:px-2 lg:px-4 py-1 lg:py-2'>
                        ...
                        <div className='grid grid-cols-2 gap-2 md:gap-3 mlg:gap-5 lg:mt-6 md:mt-4 mt-2 '>
                            <div>
                                <img className='rounded-lg h-[400px] w-full ' src="https://img.freepik.com/premium-photo/amazing-delicious-cheese-burger_727939-299.jpg" alt="" />
                            </div>
                            <div>
                                <img className='rounded-lg h-[400px] w-full ' src="https://img.freepik.com/premium-photo/amazing-delicious-cheese-burger_727939-299.jpg" alt="" />
                            </div>
                            ...
                            <div className='flex items-center justify-between  gap-3 '>
                                ...
                                <div className='flex items-center gap-4'>
                                    ...
                                    <button type="button" className="text-blue-700 border border-blue-700 hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800 dark:hover:bg-blue-500">
                                        ...
                                        <AiFillDislike className='w-4 h-4'></AiFillDislike>
                                ...
                                <div className='flex items-center gap-6 '>
                                    <h1> Share Now : </h1>
                                    <button className='text-2xl text-yellow-500'> <FaFacebook></FaFacebook>  </button>
                                    <button className='text-2xl text-yellow-500'> <FaLinkedin ></FaLinkedin>  </button>
                                    <button className='text-2xl text-yellow-500'> <FaTwitter ></FaTwitter>  </button>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <form className=" mx-auto">
                                <div className="mb-5">
                                    ...
                                    <textarea className='w-full bg-gray-900 dark:placeholder-gray-400 px-2 py-1 text-gray-200' name="commit" id="" cols="30" rows="10" placeholder="Commitments" required ></textarea>

  ...
  if (isLoading) {
    return (
      <div className="text-center flex items-center justify-center min-h-screen">
        ...
        >
          <svg
            class="md:h-16 h-10 md:w-20 w-16 animate-spin stroke-gray-500"
            viewBox="0 0 256 256"
          >
            <line
              x1="128"
          ...
          <span class="lg:text-4xl md:text-xl text-lg font-medium text-gray-500">
            Loading...
          </span>
        </div>
      </div>
              ...
              {allNewsData?.map((news, i) => (
                <tr key={news._id}>
                  ...
                  <td className=" flex items-center justify-center gap-3 md:py-6 py-4 border border-gray-400 p-2">
                    ...
                    <span
                      onClick={() => handleNewsDelete(news?._id, news?.title)}
                      className="p-1 cursor-pointer w-fit text-white text-sm rounded-md"
                    >

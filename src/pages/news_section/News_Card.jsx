                                ...
                                <div className="lg:px-2 md:px-1 px-1 py-3">
                                    ...
                                    <p className={`mb-3 font-normal text-gray-300 ${expandedNews[news.id] ? 'block' : ''} dark:text-gray-400`}>
                                        ...
                                        {news?.description.length > 40 && (
                                            <button onClick={() => handleReadMore(news.id)} className="inline-flex items-center px-3 py-2 text-md font-medium text-center text-yellow-600 rounded-lg focus:outline-none">
